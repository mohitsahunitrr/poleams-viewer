...
function switchViews(view) {
	...
	var titleNode = dojo.query("#siteViewerHeader .headerTitle")[0];
	titleNode.innerHTML = (viewId == "distribution") ? "feeder" : "line";
	
	dojo.removeClass(dojo.byId("bladeViewer"), "distribution transmission");
	dojo.addClass(dojo.byId("bladeViewer"), viewId);
	var titleNode = dojo.query("#bladeViewer .headerTitle")[0];
	titleNode.innerHTML = (viewId == "distribution") ? "pole" : "structure";
